...
class Utilisateur
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Passager", mappedBy="id_utilisateur")
     */
    private $passager;
    ...
    public function addPassager(Passager $passager): self
    {
        if (!$this->passager->contains($passager)) {
            ...
            $passager->setIdUtilisateur($this);
        }
    ...
    public function removePassager(Passager $passager): self
    {
        if ($this->passager->contains($passager)) {
            ...
            if ($passager->getIdUtilisateur() === $this) {
                $passager->setIdUtilisateur(null);
            }
        }
